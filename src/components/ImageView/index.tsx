...
function ImageView({isAuthTokenRequired = false, url, fileName, onError}: ImageViewProps) {
    ...
    console.debug(`@51888 ImageView isAuthTokenRequired ${isAuthTokenRequired} url ${url} fileName ${fileName}`);
    ...
    if (canUseTouchScreen) {
        console.debug(`@51888 ImageView isAuthTokenRequired ${isAuthTokenRequired} displaying lightbox url ${url} fileName ${fileName}`);
        return (
            <Lightbox
                uri={url}
    ...
    console.debug(`@51888 ImageView isAuthTokenRequired ${isAuthTokenRequired} displaying Image url ${url} fileName ${fileName}`);
    return (
        <View
